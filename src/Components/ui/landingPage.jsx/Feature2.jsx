      ...
      <div className="px-5 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="grid max-w-[1200px] grid-cols-1 mx-auto mt-12 text-left sm:mt-16 sm:grid-cols-4 gap-y-14 gap-x-8 lg:gap-x-20">
          ...
          <div className="relative group">
            ...
            <p className="mt-6 text-xl font-bold text-gray-900 font-pj">
            ...
            <p className="mt-2 text-truncated text-sm font-normal text-gray-600">
              ...
              lighting of the 500-year-old sixteen-point lamp called “Iná
              Olójúmẹ́ríndínlógún” (16 face lamp). The Festival culminates in a
              procession to the shrine in the sacred Osun-Osogbo grove where a
              large crowd builds up. This event is led by the sitting “Atáòjà”
              of Osogbo along with a ritualized performer called the “Arugbá”
              (calabash carrier) and a committee of priestesses.
            </p>
          ...
          <div className="relative group">
            ...
            <p className="text-truncated mt-2 text-sm font-normal text-gray-600">
              ...
              heritage and traditions of the Ijebu people, one of the prominent
              subgroups of the Yoruba ethnic group. During the festival,
              thousands of people from Ijebu-Ode and surrounding communities
              gather at the palace of the Awujale of Ijebuland, the paramount
              ruler of the Ijebu kingdom, to pay homage to the king and
              celebrate the town's cultural heritage. One of the highlights of
              the Ojude Oba Festival is the procession of the various age
              groups, each accompanied by drummers, dancers, and praise singers.
              The different groups showcase their unique cultural performances,
              including traditional music, dance routines, and acrobatic
              displays, adding to the festive atmosphere.
            </p>
          ...
          <div className="relative group">
            ...
            <p className="mt-2 text-truncated text-sm font-normal text-gray-600">
              ...
              (king) or prominent individual and to usher in a new era of
              prosperity and blessings. It is considered one of the oldest
              masquerade tradition in Nigeria and is deeply rooted in Yoruba
          ...
          <div className="relative group">
            ...
            <p className="mt-2 text-truncated text-sm font-normal text-gray-600">
              ...
              Yoruba mythology and cultural heritage, reflecting the reverence
              and significance of Sango in Yoruba religious beliefs. During the
              Sango Festival, which typically takes place annually, devotees and
              participants gather to pay homage to Sango through various
              rituals, ceremonies, and performances. The festival serves as a
              vibrant expression of Yoruba spirituality, unity, and cultural
              identity
            </p>
